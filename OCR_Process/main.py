...
from TesseractOcr_processor import TesseractProcessor
from LlamaOcr_processor import LlamaOCRProcessor
import tempfile
import fitz
...
def process_image(image, comparator, uploaded_file):
    ...
    # Create a temporary file to save the image for OCR processing
    ...
    # Display Tesseract results in a table
    ...
    # Download Tesseract results as CSV
    if tesseract_result:
